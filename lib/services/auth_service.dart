...
class AuthService {
  ...
  // Google Sign-In - TEMPORARILY DISABLED FOR RELEASE BUILD
  Future<UserCredential?> signInWithGoogle() async {
    try {
      // TODO: Fix Google Sign-In API compatibility issue
      throw UnimplementedError('Google Sign-In temporarily disabled for release build');
